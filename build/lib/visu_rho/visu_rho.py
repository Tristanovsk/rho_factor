...
from rho_factor.gen_rho import process as pr
import rho_factor.visu_rho.dash_reusable_components as drc
...
def visu():
    ...
    app.layout = html.Div(children=[
        ...
        html.Div(id='body', className='container scalable', children=[
            ...
            html.Div(
                dcc.Markdown(dedent("""
                    [Click here](https://github.com/Tristanovsk/rho_factor) to visit the project repo, and learn about how to use the rho_factor.
                    """)),
    ...
    if __name__ == '__main__':
        # rho_factor.run_server(debug=True)
        app.run_server()
